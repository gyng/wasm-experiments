...
function integrateWasmJS(Module) {
  ...
  var wasmTextFile = Module['wasmTextFile'] || '1.wast';
  var wasmBinaryFile = Module['wasmBinaryFile'] || '1.wasm';
  var asmjsCodeFile = Module['asmjsCodeFile'] || '1.temp.asm.js';
...
memoryInitializer = Module["wasmJSMethod"].indexOf("asmjs") >= 0 || Module["wasmJSMethod"].indexOf("interpret-asm2wasm") >= 0 ? "1.html.mem" : null;
